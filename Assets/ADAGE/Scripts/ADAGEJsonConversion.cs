...
static public class ADAGEJsonConversion
{
	public static void Init()
	{
		...
		ExporterFunc<UploadWrapper> wrapperExporter = new ExporterFunc<UploadWrapper>(WrapperToJson);
		JsonMapper.RegisterExporter<UploadWrapper>(wrapperExporter);
	...
	static void WrapperToJson(UploadWrapper wrapper, JsonWriter writer)
	{
		writer.WriteObjectStart();
		{
